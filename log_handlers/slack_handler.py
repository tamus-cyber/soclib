...
class SlackHandler(Handler):
    ...
    def emit(self, record: LogRecord):
        ...
        """
        msg = self.format(record)  # formatting is based on the provided Formatter when the handler is created
        ...
        self.slack_client.chat_postMessage(channel=self.channel, text=msg, username=self.username, icon_emoji=self.icon_emoji)
